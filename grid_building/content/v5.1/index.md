...
description: Documentation for Grid Building Plugin version 5.1.0
---
...
Welcome to the comprehensive documentation for **Grid Building Plugin v5.1.0** - the latest stable release with major architectural improvements and enhanced features.

{{< version-requirements minVersion="4.4" 
  recommended="4.5"
  pluginVersion="5.1.0"
  note="v5.1.0 depends on APIs introduced in Godot 4.4+"
 >}}
...
<PluginVersionInfo 
  ...
  godotVersions="4.4.0, 4.4.1, 4.5.1 stable"
  minGodotVersion="4.4+"
></PluginVersionInfo>