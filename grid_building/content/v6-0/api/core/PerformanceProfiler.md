...
description: "Performance profiler for tracking service execution times and system metrics.
Provides timing capabilities for performance monitoring and optimization."
weight: 10
url: "/gridbuilding/v6-0/api/core/performanceprofiler/"
---
...
/// <summary>
    ...
    internal void RecordTiming(string operationName, long elapsedMs)
    {
        lock (_lock)
        {
