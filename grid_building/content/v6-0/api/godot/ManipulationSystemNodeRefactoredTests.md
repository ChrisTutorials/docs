---
title: "ManipulationSystemNodeRefactoredTests"
description: "Refactored integration tests for ManipulationSystemNode following new architecture patterns.
Tests Enhanced Service Registry pattern with proper dependency injection.
Tests Core/Godot separation with clear test organization."
weight: 20
url: "/gridbuilding/v6-0/api/godot/manipulationsystemnoderefactoredtests/"
---

# ManipulationSystemNodeRefactoredTests

```csharp
GridBuilding.Godot.Tests.Manipulation
class ManipulationSystemNodeRefactoredTests
{
    // Members...
}
```

Refactored integration tests for ManipulationSystemNode following new architecture patterns.
Tests Enhanced Service Registry pattern with proper dependency injection.
Tests Core/Godot separation with clear test organization.

**Project:** GridBuilding v6.0  
**Layer:** Godot  
**Source:** `Godot/Tests/Unit/Core/ManipulationSystemNodeRefactoredTests.cs`  
...
public override void _Ready()
        {
            Name = "ManipulationSystemNodeRefactoredTests";
        }
```
