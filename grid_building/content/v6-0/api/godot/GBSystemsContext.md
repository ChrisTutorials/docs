---
title: "GBSystemsContext"
description: "Holds references to the systems used in grid building operations.
...
weight: 20
url: "/gridbuilding/v6-0/api/godot/gbsystemscontext/"
---
...
**Layer:** Godot  
**Source:** `Godot/Tests/Unit/Core/Contexts/GBSystemsContext.cs`  
...
```csharp
    ...
    /// </summary>
    public void SetSystem(IGBSystem system)
    {
        switch (system)
        {
...
```csharp
public List<string> GetRuntimeIssues(IGBRuntimeChecks? checks = null)
    {
        ...
        if (checks == null)
        {
            issues.Add("GBRuntimeChecks is null, skipping all extra runtime checks");
            return issues;
        }
