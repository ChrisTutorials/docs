---
title: "GridTargetingDebugTextTemplate"
description: "Debug text template for displaying grid targeting information.
...
weight: 20
url: "/gridbuilding/v6-0-public/api/godot/gridtargetingdebugtexttemplate/"
---

# GridTargetingDebugTextTemplate

```csharp
GridBuilding.Godot.Templates.UI.Debug
class GridTargetingDebugTextTemplate
{
    // Members...
}
```

Debug text template for displaying grid targeting information.
Provides real-time debugging information about mouse position, indicator state,
collision counts, and blocking entities in both vertical and horizontal layouts.

**Project:** GridBuilding v6.0  
**Layer:** Godot  
**Source:** `Godot/Engine/Debug/GridTargetingDebugTextTemplate.cs`  
**Namespace:** `GridBuilding.Godot.Templates.UI.Debug`  
...
```csharp
/// <summary>
    /// Update collision labels based on placement manager state.
    /// </summary>
    /// <param name="placementManager">The indicator manager</param>
    public void UpdateCollisionLabels(IndicatorManager placementManager)
    {
        if (!GodotObject.IsInstanceValid(placementManager))
        {
        ...
        var collisionCount = placementManager.GetCollidingIndicators().Count;
        _lines["collision_count"] = collisionCount.ToString();

        var bodies = placementManager.GetCollidingNodes();
        if (bodies.Count == 0)
        {
            _lines["blocking"] = "0";
        }
...
**Parameters:**
- `IndicatorManager placementManager`
