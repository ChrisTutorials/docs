---
title: 'Version 5.0.1 - Redirected to v5.1'
description: 'v5.0.1 was never released - these changes are in v5.1.0'
---
...
<Aside type="caution" title="This Page Has Moved">
**Version 5.0.1 was never released.** All improvements originally planned for v5.0.1 are included in [v5.1.0](/v5-1/).

Please see the [v5.1 Breaking Changes Guide](/v5-1/migration/breaking-changes/) for migration details.
</Aside>

## What Happened?

The improvements originally planned as a v5.0.1 patch release (particularly the metadata-based placement persistence system) were significant enough to warrant a minor version bump to v5.1.0 instead.

## Where to Find This Content

- **Placement Persistence Changes**: See [v5.1 Breaking Changes](/v5-1/migration/breaking-changes/)
- **Migration Instructions**: See [v5.1 Placement Persistence Guide](/v5-1/guides/placement-persistence/)
...
- 📖 [Placement Persistence Guide](/v5-1/guides/placement-persistence/) - Complete guide with examples
