...
description: Important breaking changes and migration notes for v5.0.0
---
...
<MigrationLink version="5.0.0" ></MigrationLink>
...
- **For keyboard/code-driven modes:** Visibility now works correctly without workarounds (requires v5.1+)
