...
description: "Why and how GridBuilding is migrating from GDScript to C# for superior performance and maintainability"
---


> **📋 Version-Specific Guide:** This migration is a key feature of **v5.1**. See the [v5.1 Migration Guide](../../v5.1/migration/gdscript-to-csharp/) for implementation details and version-specific steps.

---

## 🎯 Overview

GridBuilding is migrating from GDScript to C# to achieve **professional-grade development experience** with superior performance, type safety, and maintainability. This migration represents a fundamental upgrade to our architecture and development workflow.
...
- **[v5.1 Migration Guide](../../v5.1/migration/gdscript-to-csharp/)** - Implementation details and version-specific changes
- **[v5.1 Migration Overview](../../v5.1/migration/)** - Complete v5.1 migration resources

### **General Documentation**
- **[Service-Based Architecture Guide](service-based-architecture/)** - Understanding the architecture
- **[Getting Started with C#](getting-started/)** - C# development setup
